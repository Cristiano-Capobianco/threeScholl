...
("description"); // string
("An apple mobile which is nothing like apple"); // string
...
//permission ha il valore "ALL" che è una stringa
//products ha un array con 2 oggetti
...
//Stampare in console il secondo elemento di todo del primo oggetto
...
console.log(mock[1].hasOwnProperty("todo"));
