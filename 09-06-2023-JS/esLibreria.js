// Costruire una libreria con 5 libri. Ogni libro deve contenere le seguenti informazioni:

// nome (text),
// autore (text),
// se è stato letto da almeno un utente (boolean)
// data di uscita del libro (formato yyyy-MM-dd)
// numero di pagine per capitolo del libro (array bidimensionale)

// 1 contare tutti i libri di autori che iniziano per M (o m)
// 2 contare il numero di pagine dei libri
// 3 aggiornamento il valore letto al suo opposto (es.true=false:false=true) per ogni libro
...
let libro1 = new libro("Pinocchio", "Collodi", true, new Date(2018, 1, 12), [
  [1, 2],
  [2, 4],
  [3, 5],
]);
let libro2 = new libro("Cuore", "De Amicis", true, new Date(1999, 6, 22), [
  [1, 43],
  [2, 14],
  [3, 15],
]);
